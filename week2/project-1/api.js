...
I was attempting to write a for loop to choose random data?*/

ships.results.map(function(starShip){
    let li = document.createElement("li");
    li.textContent = JSON.stringify(starShip, null, "---") ;
    data.append(li);
    li.style.backgroundColor="red";
    li.style.padding= "10px";
});
/* why didnt we use JSON.parse */
